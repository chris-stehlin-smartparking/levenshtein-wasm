...
function postInstantiate(baseModule, instance) {
    ...
    function __allocString(str) {
        ...
        checkMem();
        for (let i = 0, j = ref >>> 1; i < length; ++i)
            U16[j + i] = str.charCodeAt(i);
        return ref;
    }
    ...
    for (const internalName in exports) {
        ...
        if (hash >= 0) {
            ...
            if (typeof classElem === 'undefined' || !classElem.prototype) {
                const ctor = (...args) => ctor.wrap(ctor.prototype.constructor(0, ...args));
                ctor.prototype.valueOf = function valueOf() {
                    return this[THIS];
                };
